...
func (in *SchedulingProfile) DeepCopyInto(out *SchedulingProfile) {
	*out = *in
	if in.Plugins != nil {
		in, out := &in.Plugins, &out.Plugins
		*out = make([]SchedulingProfilePlugin, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SchedulingProfilePlugin) DeepCopyInto(out *SchedulingProfilePlugin) {
	*out = *in
	if in.Weight != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchedulingProfilePlugin.
func (in *SchedulingProfilePlugin) DeepCopy() *SchedulingProfilePlugin {
	if in == nil {
		return nil
	}
	out := new(SchedulingProfilePlugin)
	in.DeepCopyInto(out)
	return out
}
